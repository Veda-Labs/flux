...
contract DeploySorellaVaultSimple is Script {
    ...
    PoolId internal eth_usdc_pool_id = PoolId.wrap(0x93C94B1DFDD338D2325D8F04DB8F8F7057DD85FFBA6CDA061D3744BC1E4ED7B9);
    address internal ETH_USD_ORACLE = 0x5f4eC3Df9cbd43714FE2740f5E3616155c5b8419;
    address internal hook = 0xb9c4cE42C2e29132e207d29Af6a7719065Ca6AeC; // angstrom
    ...
    function run() public {
        ...
        // grant teller executor role
        rolesAuthority.setUserRole(0x00Fa67b1B31401D0743109AdF43257949c7C55D2, 42, true);

        // set 1inch aggregator
        manager.setAggregator(0x111111125421cA6dc452d289314280a0f8842A65, true);

        // TODO: deploy and complete all other prod roles
        // TODO: ownership xfer

        // LOGS:
        console.log("Vault:", address(boringVault));
